    ...
    <form method="POST" action="{{ route('products.update', $product) }}" enctype="multipart/form-data">
        ...
        <div class="overflow-hidden shadow sm:rounded-md">
            ...
            <div class="bg-gray-50 px-4 py-3 text-right sm:px-6 space-x-2">
                ...
                <button type="submit" class="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700">Update</button>
            </div>
        </div>
    </form>
</div>
